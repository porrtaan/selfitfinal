              ...
              <div class="row">
                <div class="col-md-8 mx-auto">
                  <div class="detail_box">
                    ...
                    <p>
                      Transforme o seu treino com a Selfit: Equipamentos de ginásio de qualidade premium para resultados extraordinários.   
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-5 ml-auto">
          <div class="detail-box">
            ...
            <p>
              Seja bem-vindo à Selfit, a sua loja de máquinas de ginásio de eleição! Aqui encontrará uma vasta seleção de equipamentos de fitness de alta qualidade para transformar o seu treino numa experiência verdadeiramente gratificante. Desde passadeiras e bicicletas estáticas a pesos livres e máquinas multifunções, temos tudo o que precisa para criar o seu próprio ginásio em casa ou equipar o seu espaço de treino profissional. Conte com a nossa equipa especializada para o ajudar a encontrar as melhores opções que se adequam às suas necessidades e objetivos de fitness. Visite-nos hoje e comece já a alcançar os seus objetivos de saúde e bem-estar com a Selfit!
            </p>
        ...
        <div class="col-lg-4 col-md-6 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <p>
                Acelere seu progresso sem sair de casa! Desfrute de entrega gratuita em todos os pedidos e concentre-se no seu treino. Sem preocupações!
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <p>
                Devolução descomplicada na Selfit Garantia de satisfação ou seu dinheiro de volta! Simplificamos o processo para sua total tranquilidade.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <p>
                 Na Selfit Estamos aqui para você a qualquer momento, em qualquer lugar! Conte com nossa equipe dedicada para resolver suas dúvidas.
              </p>
            </div>
          </div>
        </div>
