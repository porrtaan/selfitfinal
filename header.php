          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="exercicios.php">Alongamentos</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="educao.php">Educação</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="automonitoraçao.php">Automonitorização</a>
                </li>
              </ul>
            </div>
